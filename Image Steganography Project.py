...
def Encode():
    ...
    EncScreen.config(bg="pink")
    label = Label(text="Enter Your Message")
    label.place(relx=0.1,rely=0.2)
    entry=Entry()
    entry.place(relx=0.5,rely=0.2)
    label1 = Label(text="Name of Output File")
    ...
    SelectButton = Button(text="Select Image file",command=OpenFile)
    SelectButton.place(relx=0.1,rely=0.4)
